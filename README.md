...
Исправлены баги:
1. ✅ Обновление профиля между шагами формы
2. ✅ Logout очищает старые данные
3. ✅ Одновременные 401 синхронизируют refresh через Promise
4. ✅ Специализации получают больше 10 записей
5. ✅ Навыки получают больше 10 записей
6. ✅ Поиск навыков с debounce
7. ✅ Выбранные навыки не исчезают при поиске
8. ✅ Проверить и исправить auth lifecycle после неудачного refresh
9. ✅ Затем финальная проверка пагинации/поиска и всего профиля